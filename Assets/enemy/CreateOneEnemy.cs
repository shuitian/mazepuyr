...
public class CreateOneEnemy : MonoBehaviour {
	...
	void GenerateRandomLocation () {
        RandX = Random.Range(Level1Statement.terrainMinX + 1, Level1Statement.terrainMaxX - 1);
        RandZ = Random.Range(Level1Statement.terrainMinZ + 1, Level1Statement.terrainMaxZ - 1);
	}
