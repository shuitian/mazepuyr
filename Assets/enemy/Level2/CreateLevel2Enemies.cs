...
public class CreateLevel2Enemies : CreateLevelEnemies
{
    ...
    void Update()
    {
        if (GameStatement.levelStatementIsDone)
        {
            ...
            {
                GameObject clone = Instantiate(sphereEnemyStatement.getObj(), new Vector3(GameStatement.levelStatement.terrainMaxX / 2, 1, GameStatement.levelStatement.terrainMaxZ / 2), Random.rotation) as GameObject;
            ...
            {
                GameObject clone = Instantiate(cubeEnemyStatement.getObj(), new Vector3(GameStatement.levelStatement.terrainMaxX / 2, 1, GameStatement.levelStatement.terrainMaxZ / 2), Random.rotation) as GameObject;
