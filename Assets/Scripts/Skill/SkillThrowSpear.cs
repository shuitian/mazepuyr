...
public class SkillThrowSpear : MonoBehaviour
{
    ...
    public void shoot()
    {
        ...
        GameObject clone = ObjectPool.Instantiate(bulletPrefab, attacker.transform.position, Quaternion.FromToRotation(Vector3.forward, (toBeAttacked.transform.position - attacker.transform.position).normalized)) as GameObject;
